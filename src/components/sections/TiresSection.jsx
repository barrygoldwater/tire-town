...
export default function TiresSection({ onProductClick, category }) {
  const [activeBrand, setActiveBrand] = useState("All");

  const tires = inventory.tires.filter(t => (t.vehicle_type || "golf_cart") === category);
